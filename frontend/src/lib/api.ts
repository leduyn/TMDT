...
export const orderApi = {
  ...
  create: (data: OrderRequest) => fetchJSON<MessageResponse>('/api/orders', {
    method: 'POST',
    body: JSON.stringify(data)
  }),
  createByAgency: (data: OrderRequest) => fetchJSON<MessageResponse>('/api/orders/by-agency', {
    method: 'POST',
    body: JSON.stringify(data)
  }),
  createByEmployee: (data: OrderRequest) => fetchJSON<MessageResponse>('/api/orders/by-employee', {
    method: 'POST',
    body: JSON.stringify(data)
  }),
