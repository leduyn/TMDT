...
public class AgencyService {
    ...
    @SuppressWarnings("null")
    @Transactional
    public AgencyDTO createAgencyWithAccount(AgencyWithAccountRequest request) {
    ...
    public List<UserDTO> getCustomersByAgency(Long agencyId) {
        List<AgencyCustomerAssignment> assignments = assignmentRepository.findByAgencyId(agencyId);
    ...
    public void approveCustomer(Long agencyId, Long customerId) {
        AgencyCustomerAssignment assignment = assignmentRepository.findByAgencyIdAndCustomerId(agencyId, customerId)
